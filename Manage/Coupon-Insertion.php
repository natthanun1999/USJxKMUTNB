                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" style="width: 100%">
                    <ul class="navbar-nav mr-auto"> <!-- mr-auto -->
                        ...
                        <?php
                            ...
                            $_SESSION['PRE-PAGE'] = "Manage/Coupon-Insertion.php";
            ...
            <div class="main-content">
                <div class="content-item">
                    <div class="jumbotron jumbotron-dark text-center">
                        <h1>Coupon Insertion</h1>

                        <p>
                            Discount coupon is not enough? Let's add more gifts.
                        </p>
                    </div>

                    <div class="jumbotron jumbotron-dark">
                        <div class="col-md-6 mx-auto">
                            <form action="../Back-end/Coupon-Insertion.php" method="POST">
                                <input name="RATE" type="text" class="form-control push-sm" placeholder="Discount rate(%)" required>

                                <select name="STATUS" class="form-control push-sm">
                                    <option value="Idle" selected>Select coupon status</option>
            ...
            if (isset($_POST['INSERTION']))
            {
                if ($_POST['INSERTION'])
                {
                    $alert = "Swal.fire({
                                         ...
                                         text: 'Let\'s give some gift to customers.',
                                         icon: 'success',
